...
testing
"""
#先将评论过从excel中滤分词保存到txt文件中
storepath = 'E:/GraduationProject/pythoncode/project/Prediction/main/result/Informative_Motorala.txt'
...
#文档的相似度
storepath_1 = 'E:/GraduationProject/pythoncode/project/Prediction/main/result/Informative_Motorala_tfidf.txt'
centroid(storepath,storepath_1)