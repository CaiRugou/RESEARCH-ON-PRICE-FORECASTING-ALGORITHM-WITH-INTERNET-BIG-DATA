...
def seg_filter_txt(filepath, storepath):
    ...
    stopfile = open('E:/GraduationProject/pythoncode/project/Prediction/main/PreprocessingModule/stopword.txt','r')
...
testing
"""
storepath = 'E:/GraduationProject/pythoncode/project/Prediction/main/result/Informative_Motorala_rs.txt'
filepath = 'E:/GraduationProject/pythoncode/project/Prediction/main/ReviewSet/Motorala.xlsx'
store_seg_fil_result(filepath,1,11,storepath)

#产品描述文本
filepath_edit = 'E:/GraduationProject/pythoncode/project/Prediction/main/FeatureExtractionModule/InformativeFeatures/ReviewAndEditorialReviewSimilarity/EditorialReviewExample.txt'
storepath_query ='E:/GraduationProject/pythoncode/project/Prediction/main/result/Informative_query.txt'
seg_filter_txt(filepath_edit,storepath_query)
#计算问点的相似度
result = 'E:/GraduationProject/pythoncode/project/Prediction/main/result/Informative_gensim.txt'
gensim(storepath,storepath_query,result)
