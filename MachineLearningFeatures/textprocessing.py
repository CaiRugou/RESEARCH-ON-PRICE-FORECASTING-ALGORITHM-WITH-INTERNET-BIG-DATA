...
import jieba
import jieba.posseg
jieba.load_userdict('E:/GraduationProject/pythoncode/project/Prediction/main/PreprocessingModule/userdict.txt')
...
def seg_fil_excel(filepath, sheetnum, colnum):
    ...
    """
    stopwords = get_txt_data('E:/GraduationProject/pythoncode/project/Prediction/main/PreprocessingModule/stopword.txt','lines')
...
def seg_fil_senti_excel(filepath, sheetnum, colnum):
    ...
    """
    sentiment_stopwords = get_txt_data('E:/GraduationProject/pythoncode/project/Prediction/main/PreprocessingModule/sentiment_stopword.txt','lines')
    # Filter stopwords from reviews
