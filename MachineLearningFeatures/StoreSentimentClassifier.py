...
"""
pos_review = tp.seg_fil_senti_excel('E:/GraduationProject/pythoncode/project/Prediction/main/FeatureExtractionModule/SentimentFeatures/MachineLearningFeatures/SenimentReviewSet/pos_review.xlsx',1,1)
neg_review = tp.seg_fil_senti_excel('E:/GraduationProject/pythoncode/project/Prediction/main/FeatureExtractionModule/SentimentFeatures/MachineLearningFeatures/SenimentReviewSet/neg_review.xlsx',1,1)
pos = pos_review
neg = neg_review
...
"""
classif = SklearnClassifier(BernoulliNB())
classif.train(train_set)
predict = classif.classify_many(test)
print accuracy_score(tag_test, predict)
"""
#
...
def p_score(classifier):
    classifier=SklearnClassifier(classifier)
    classifier.train(trainset)
    pred = classifier.classify_many(test)
    return precision_score(tag_test,pred)
...
for d in dimention:
    ...
    print "all of  accuracy is ",score(BernoulliNB()),' ',score(MultinomialNB()),' ',score(LogisticRegression()),' ',score(SVC()),' ',score(LinearSVC()),' ',score(NuSVC()),' ',score(tree.DecisionTreeClassifier()),' ',score(BaggingClassifier(KNeighborsClassifier(),max_samples=0.5,max_features=0.5)),' ',score(RandomForestClassifier(n_estimators=20, max_depth=None, min_samples_split=1, random_state=0))
    print '\n'
    print "all of recall is ",get_recall(BernoulliNB()),' ',get_recall(MultinomialNB()),' ',get_recall(LogisticRegression()),' ',get_recall(SVC()),' ',get_recall(LinearSVC()),' ',get_recall(NuSVC()),' ',get_recall(tree.DecisionTreeClassifier()),' ',get_recall(BaggingClassifier(KNeighborsClassifier(),max_samples=0.5,max_features=0.5)),' ',get_recall(RandomForestClassifier(n_estimators=20, max_depth=None, min_samples_split=1, random_state=0))
    print '\n'

    print "all of f-measure is ",get_fmeasure(BernoulliNB()),' ',get_fmeasure(MultinomialNB()),' ',get_fmeasure(LogisticRegression()),' ',get_fmeasure(SVC()),' ',get_fmeasure(LinearSVC()),' ',get_fmeasure(NuSVC()),' ',get_fmeasure(tree.DecisionTreeClassifier()),' ',get_fmeasure(BaggingClassifier(KNeighborsClassifier(),max_samples=0.5,max_features=0.5)),' ',get_fmeasure(RandomForestClassifier(n_estimators=20, max_depth=None, min_samples_split=1, random_state=0))
    print '\n'
...
store_classifier(BernoulliNB(),trainset,filename)