...
class ProductSpider(CrawlSpider):
    ...
    rules=[
        Rule(SgmlLinkExtractor(allow=(r'http://detail.zol.com.cn/cell_phone_index/subcate57_0_list_1_0_1_1_0_\d+\.html'))),
        Rule(SgmlLinkExtractor(allow=(r'http://detail.zol.com.cn/cell_phone/index\d+\.shtml',
